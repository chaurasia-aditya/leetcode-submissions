...
//             max_f[i] = Math.max(max_f[i-1], nums[i]);
            
//             min_r[nums.length-1-i] = Math.min(min_r[nums.length-i], nums[nums.length-1-i]);
//             max_r[nums.length-1-i] = Math.max(max_r[nums.length-i], nums[nums.length-1-i]);
        }
